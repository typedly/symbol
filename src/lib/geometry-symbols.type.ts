...
export type GeometrySymbol =
  ...
  | '∥'   // Parallel symbol (U+2225) - The parallel lines symbol (||) highlights lines that maintain a consistent distance.
  | '≅'   // Congruent to symbol (U+2245) - The congruence symbol ≅ signifies that two shapes are identical in size and shape.
  | 'Δ'   // Delta symbol for change (U+0394)
;
